    ...
    _createClass(Ctrl, [{
      ...
      value: function _createChart(data) {
        ...
        return Highcharts.chart('iz-container', {
          ...
          series: [{"name":"CUADRO","data":[17.34,16.15,14.64,14.02,15.24,14.88,0,15.08,15.21,15.28,0]},{"name":"CAMA","data":[34.44,32.9,30.68,29.51,31.01,31.11,0,32.22,33.14,33.78,0]},{"name":"SEVERIDAD","data":[9.56,8.28,7.63,7.55,8.22,8.05,0,7.99,8.38,8.37,0]}]
        });
      }
    }, {
      key: 'flip',
